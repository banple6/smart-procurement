...
val LogiOnSecondary = Color(0xFFFFFFFF)
val LogiOnSurface = Color(0xFF1D252D)
val LogiOnSurfaceVariant = Color(0xFF6B7680)

val LogiOutline = Color(0xFFB8C3CC)
val LogiOutlineVariant = Color(0xFFD7E0E7)
