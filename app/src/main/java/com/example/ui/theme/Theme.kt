...
internal val JrxpDarkColorScheme = darkColorScheme(
    primary = Color(0xFF78B7EA),
    onPrimary = Color(0xFF062844),
    primaryContainer = Color(0xFF153B5B),
    onPrimaryContainer = Color(0xFFD2E9FC),
    secondary = Color(0xFF9CC9ED),
    onSecondary = Color(0xFF0A2B45),
...
val DarkExtendedColors = JrxpExtendedColors(
    ...
    dutyBlue = Color(0xFF78B7EA),
    dispatchBlue = Color(0xFF9CC9ED),
