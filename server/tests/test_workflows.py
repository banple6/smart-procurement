...
def test_admin_static_assets_avoid_cdn_storage_and_repeated_stale_label():
    ...
    assert '/admin-assets/dashboard.css?v=0.3.7.1' in dashboard_html
    assert '/admin-assets/dashboard.js?v=0.3.7.4' in dashboard_html
    assert '/admin-assets/refresh-policy.js?v=1.0.0' in dashboard_html
